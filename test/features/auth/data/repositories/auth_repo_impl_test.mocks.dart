...
import 'package:flower_app/core/api/models/response/user_dto.dart' as _i5;
...
class MockAuthDataSource extends _i1.Mock implements _i2.AuthDataSource {
  ...
  @override
  _i3.Future<_i4.Result<_i5.UserDto>> signUp(_i6.UserRequest? request) =>
      (super.noSuchMethod(
            Invocation.method(#signUp, [request]),
            returnValue: _i3.Future<_i4.Result<_i5.UserDto>>.value(
              _i7.dummyValue<_i4.Result<_i5.UserDto>>(
                this,
                Invocation.method(#signUp, [request]),
              ),
            ),
          )
          as _i3.Future<_i4.Result<_i5.UserDto>>);
}
